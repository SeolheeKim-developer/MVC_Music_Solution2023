...
namespace MVC_Music.Data
{
    public class MusicContext : DbContext
    {
        ...
        public DbSet<PerformanceSongSummaryVM> PerformanceSongSummaries { get; set; }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            //For the PerformanceSongSummary ViewModel
            //Note: The Database View name is PerformanceSongSummaries
            modelBuilder
                .Entity<PerformanceSongSummaryVM>()
                .ToView(nameof(PerformanceSongSummaries))
                .HasKey(a => a.ID);
